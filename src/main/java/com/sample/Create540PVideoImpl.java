...
public class Create540PVideoImpl {
	...
	public void createVideo(String format) {	
		...
		outputGroup = OutputGroup.builder()
				.name("APPLE HLS ABR 540P VIDEO ENCODING")
	...
	public static void main(String[] args) {
		...
		Create540PVideoImpl createVideo = new Create540PVideoImpl();
		createVideo.createVideo("540p");
